...
// ── Firebase Firestore REST API KV ──
// Uses the same REST API approach as scripts/kv-firebase.js for consistency.
// Both use raw keys as Firestore doc IDs (e.g., "bot:config").
